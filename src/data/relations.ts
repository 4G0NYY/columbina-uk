...
export const RELATIONS: Relation[] = [
  ...
  },
  {
    ...
    note: "The enemy the Wild Hunt sent. He overpowered her twice and she took a wound meant for another; drifting backward through time she found him blameless of a later crime, and a repentant Rerir cleared her path home.",
    x: 74,
    y: 80,
  },
  {
  ...
  },
  {
    ...
    note: "A Luonnotar of the Frostmoon Scions. She met Columbina with an apology for the sins of ancestors and hid her away in Silvermoon Hall to recover. The Scions, Columbina was glad to find, had changed.",
    x: 22,
    y: 78,
  },
  {
