...
export const ETYMOLOGY: Etymology[] = [
  ...
  },
  {
    ...
    body:
      "From hypo- (beneath) and selēnē (moon — also Selene, the Greek moon goddess), with a feminine ending. In-game she says it means “Born Beneath the Moon.” The first name that was truly hers to give.",
  },
  {
    term: "Kuutar",
