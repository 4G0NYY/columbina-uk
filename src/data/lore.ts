...
export const LORE_DEEP_SECTIONS: LoreSection[] = [
  ...
  },
  {
    ...
    body: [
      "There was quiet, too. She helped a kuuhenki named Maalaus gather pigments, and he painted her as she once was — a goddess of the Frostmoon Scions. A wandering lyre led her and the Traveler to the artisan Aino; a mural of Rainbowdrop Crystals lit a path home for a lost Scion child.",
  ...
  },
  {
    ...
    title: "Homecoming",
    body: [
      "She chose to live among the Frostmoon Scions again. She revived Luonnotar and gave it free will; let a winged statue be raised in her likeness; learned to cook — badly, then quickly — and slipped small gifts to her friends, a new wind glider to the Traveler for the company.",
